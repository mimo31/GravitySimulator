...
enum ViewState
{
    ...
    ANIM_PAUSING, ANIM_RESUMING, ANIM_HELP, ANIM_SETTINGS, ANIM_ADD_OBJECT_TO_GRAVITY, ANIM_ADD_OBJECT_CANCEL, ANIM_PAUSE_TO_ADD_OBJECT, ANIM_ADD_OBJECT_TO_PAUSE
}